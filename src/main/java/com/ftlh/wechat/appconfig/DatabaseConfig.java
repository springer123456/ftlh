...
@ComponentScan(basePackages = {"com.ftlh.wechat.device.dao","com.ftlh.wechat.device.service","com.ftlh.wechat.device.model","com.ftlh.device.sevice.impl"})
...
public class DatabaseConfig {
	...
	DataSource getDataSource(){
		...
		dataSource.setUrl("jdbc:mysql://caohaiwang.mysql.rds.aliyuncs.com:3306/ftlh?useUnicode=true&characterEncoding=UTF-8&zeroDateTimeBehavior=convertToNull");
...
//	}
	...
	SqlSessionFactoryBean getsqlSessionFactory(){
		...
		try {
			sqlSessionFactory.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath:com/ftlh/wechat/device/mapping/*.xml"));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
